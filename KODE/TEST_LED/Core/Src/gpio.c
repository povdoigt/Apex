...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LED0G_Pin|LED0B_Pin|LED0R_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED1G_Pin|LED1B_Pin|LED1R_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : CS_GRYO_Pin LED1G_Pin LED1B_Pin LED1R_Pin */
  GPIO_InitStruct.Pin = CS_GRYO_Pin|LED1G_Pin|LED1B_Pin|LED1R_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
