...
// =======================================================================
#define APEX_CFG_PROFILE_TEST		0 // Test profile (for unit testing and development)
#define APEX_CFG_PROFILE_MISSION	1 // Mission profile (for actual deployment)

// =======================================================================
// Test profiles (only used if APEX_CFG_PROFILE_TEST is set to 1)
// =======================================================================
#define APEX_CFG_UTEST				0 // Sequential unit test profile
// ... add more test profiles as needed

// =======================================================================
// Mission profiles (only used if APEX_CFG_PROFILE_MISSION is set to 1)
// =======================================================================
#define APEX_CFG_MISSION_DEFAULT	1 // Default mission profile
// ... add more mission profiles as needed
