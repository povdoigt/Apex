...
// REG 5D is mode specific, 5C~60 are reserved
...
#define sx127x_REG_09_PA_CONFIG_PA_SELECT_MASK 0b10000000
...
#define sx127x_REG_09_PA_CONFIG_MAX_POWER_MASK 0b01110000
...
#define sx127x_REG_09_PA_CONFIG_OUTPUT_POWER_MASK 0b00001111
...
#define sx127x_REG_0B_OCP_OCP_ON_MASK 0b00100000
// [4-0] OcpTrim: OCP current trim setting
#define sx127x_REG_0B_OCP_OCP_TRIM_MASK 0b00011111
...
#define sx127x_REG_0C_LNA_LNA_GAIN_MASK 0b11100000
// [4-3] LnaBoostLf:
...
// ====================== 0x40 RegDioMapping1 ======================
// [7-6] DIO0 Mapping:
typedef enum sx127x_REG_40_DIO_MAPPING1_DIO0 {
	sx127x_REG_40_DIO_MAPPING1_DIO0_RX_DONE		= 0b00000000,	// RxDone
	sx127x_REG_40_DIO_MAPPING1_DIO0_TX_DONE		= 0b01000000,	// TxDone
	sx127x_REG_40_DIO_MAPPING1_DIO0_CAD_DONE	= 0b10000000,	// CadDone
	// 11 reserved
} sx127x_REG_40_DIO_MAPPING1_DIO0;
#define sx127x_REG_40_DIO_MAPPING1_DIO0_MSK 0b11000000
// [5-4] DIO1 Mapping:
typedef enum sx127x_REG_40_DIO_MAPPING1_DIO1 {
	sx127x_REG_40_DIO_MAPPING1_DIO1_RX_TIMEOUT			= 0b00000000,	// RxTimeout
	sx127x_REG_40_DIO_MAPPING1_DIO1_FHSS_CHANGE_CHANNEL	= 0b00100000,	// FhssChangeChannel
	sx127x_REG_40_DIO_MAPPING1_DIO1_CAD_DETECTED		= 0b01000000,	// CadDetected
	// 11 reserved
} sx127x_REG_40_DIO_MAPPING1_DIO1;
#define sx127x_REG_40_DIO_MAPPING1_DIO1_MSK 0b00110000
// [3-2] DIO2 Mapping:
typedef enum sx127x_REG_40_DIO_MAPPING1_DIO2 {
	sx127x_REG_40_DIO_MAPPING1_DIO2_FHSS_PRESENT_CHANNEL	= 0b00000000,	// FhssPresentChannel
	sx127x_REG_40_DIO_MAPPING1_DIO2_FHSS_PRESENT_CHANNEL1	= 0b00000100,	// FhssPresentChannel (same as 00)
	sx127x_REG_40_DIO_MAPPING1_DIO2_FHSS_PRESENT_CHANNEL2	= 0b00001000,	// FhssPresentChannel (same as 00)
	// 11 reserved
} sx127x_REG_40_DIO_MAPPING1_DIO2;
#define sx127x_REG_40_DIO_MAPPING1_DIO2_MSK 0b00001100
// [1-0] DIO3 Mapping:
typedef enum sx127x_REG_40_DIO_MAPPING1_DIO3 {
	sx127x_REG_40_DIO_MAPPING1_DIO3_CAD_DONE			= 0b00000000,	// CadDone
	sx127x_REG_40_DIO_MAPPING1_DIO3_VAILD_HEADER		= 0b00000001,	// ValidHeader
	sx127x_REG_40_DIO_MAPPING1_DIO3_PAYLOAD_CRC_ERROR	= 0b00000010,	// PayloadCrcError
	// 11 reserved
} sx127x_REG_40_DIO_MAPPING1_DIO3;
...
// ====================== 0x41 RegDioMapping2 ======================
// [7-6] DIO4 Mapping:
typedef enum sx127x_REG_41_DIO_MAPPING2_DIO4 {
	sx127x_REG_41_DIO_MAPPING2_DIO4_CAD_DETECTED	= 0b00000000,	// CadDetected
	sx127x_REG_41_DIO_MAPPING2_DIO4_PLL_LOCK		= 0b01000000,	// PllLock
	sx127x_REG_41_DIO_MAPPING2_DIO4_PLL_LOCK1		= 0b10000000,	// PllLock (same as 01)
	// 11 reserved
} sx127x_REG_41_DIO_MAPPING2_DIO4;
#define sx127x_REG_41_DIO_MAPPING2_DIO4_MSK 0b11000000
// [5-4] DIO5 Mapping:
typedef enum sx127x_REG_41_DIO_MAPPING2_DIO5 {
	sx127x_REG_41_DIO_MAPPING2_DIO5_MODE_READY	= 0b00000000,	// ModeReady
	sx127x_REG_41_DIO_MAPPING2_DIO5_CLK_OUT		= 0b01000000,	// ClkOut
	sx127x_REG_41_DIO_MAPPING2_DIO5_CLK_OUT1	= 0b10000000,	// ClkOut (same as 01)
	// 11 reserved
} sx127x_REG_41_DIO_MAPPING2_DIO5;
...
#define sx127x_REG_70_PLL_HOP_FAST_HOP_ON_MASK 0b10000000
// [6-0] Reserved
...
#define sx127x_REG_4B_TCXO_TCXO_INPUT_ON_MASK 0b00010000
// [3-0] Reserved
...
#define sx127x_REG_4D_PA_DAC_PA_DAC_MASK 0b00000111
// [3-0] Reserved
...
// [7-6] Unused
// [5-0] AgcReference:
#define sx127x_REG_61_AGC_REF_AGC_REFERENCE_MASK 0b00111111
...
// [7-5] Unused
// [4-0] AgcThresh1:
#define sx127x_REG_62_AGC_THRESH1_AGC_THRESH1_MASK 0b00011111
...
// ====================== 0x63 RegAgcThresh2 ======================
// [7-4] AgcThresh2:
#define sx127x_REG_63_AGC_THRESH2_AGC_THRESH2_MASK 0b11110000
// [3-0] Unused
#define sx127x_REG_63_AGC_THRESH2_AGC_THRESH3_MASK 0b00001111
...
// ====================== 0x64 RegAgcThresh3 ======================
// [7-4] AgcThresh2:
#define sx127x_REG_63_AGC_THRESH2_AGC_THRESH4_MASK 0b11110000
// [3-0] Unused
#define sx127x_REG_63_AGC_THRESH2_AGC_THRESH5_MASK 0b00001111
