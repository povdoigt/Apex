...
TASK_BMI088_Read_ARGS task_BMI088_ReadAcc_args;
TASK_BMI088_Read_ARGS task_BMI088_ReadGyr_args;
/* USER CODE END 0 */
...
int main(void)
{
  ...
  const osThreadAttr_t TASK_BMI088_ReadAcc_attributes = {
  ...
  const osThreadAttr_t TASK_BMI088_ReadGyr_attributes = {
  ...
  osThreadNew(TASK_BMI088_ReadAcc, (void *)&task_BMI088_ReadAcc_args,
              &TASK_BMI088_ReadAcc_attributes);
  osThreadNew(TASK_BMI088_ReadGyr, (void *)&task_BMI088_ReadGyr_args,
              &TASK_BMI088_ReadGyr_attributes);
