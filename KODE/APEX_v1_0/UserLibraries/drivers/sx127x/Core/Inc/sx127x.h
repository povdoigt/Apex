...
sx127x_status_t sx127x_TxSend_RTOS_base(sx127x_t *chip, const uint8_t *data, uint16_t len, bool lock_sem);
sx127x_status_t sx127x_RxReceive_RTOS_base(sx127x_t *chip, uint8_t *data, uint16_t *len, bool lock_sem);
