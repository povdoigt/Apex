...
const sx127x_LORA_config_t sx127x_LORA_config = {
...
const sx127x_FSK_OOK_config_t sx127x_FSK_OOK_config = {
	.bitrate = 200000,
...
const sx127x_modulation_t sx127x_modulation_1 = sx127x_MODULATION_LORA;
...
const sx127x_modulation_t sx127x_modulation_2 = sx127x_MODULATION_LORA;
