...
void setup(void) {
    ...
    sx127x_status_t status = sx127x_Init(&sx127x_1, sx127x_base_config_1, sx127x_modulation_1, (sx127x_mod_config_t){.fsk_ook = sx127x_FSK_OOK_config_1});
...
void loop(void) {
    ...
    sx127x_status_t status = sx127x_RxReceive(&sx127x_1, buf, &len);
